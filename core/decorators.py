...
# from Intimasia.settings import 
import Intimasia.settings as settings
# import requests
...
def exhibitor_required(view_func=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/login', message=default_message):
    """
    Decorator for views that checks that the user is logged in and is
    staff, displaying message if provided.
    """
